...
// import "../styles/Settings.css"; // Ensure this CSS file exists
...
//   const [profilePhoto, setProfilePhoto] = useState(localStorage.getItem("profilePhoto") || "default-profile.png"); // Default image
...
//           <div className="form-group">
//             <label>Email:</label>
//             <input type="email" name="email" value={adminDetails.email} onChange={handleChange} required />
//           </div>
//           <div className="form-group">
//             <label>Phone:</label>
...
//           <div className="form-group">
//             <label>Role:</label>
//             <input type="text" value={adminDetails.role} disabled />
//           </div>
